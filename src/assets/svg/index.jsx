...
export const LogoSvg = ({ className }) => {
  return (
    <svg
      ...
      className={className}
    >
      <g clipPath="url(#clip0_100_7744)">
        <path
          d="M92.9711 29.8217L89.3132 40.8541L88.1485 44.368C87.2717 43.6416 86.3752 42.9349 85.4591 42.2348H85.4525C83.6073 40.8148 81.6769 39.421 79.6484 38.0731C62.2622 26.4517 45.707 22.6368 37.2985 20.785C29.7015 19.1164 22.6279 18.2461 16.3003 17.8666L22.0455 0.5C29.2827 0.984223 37.6388 2.11626 46.7016 4.42613C54.868 6.50698 79.2558 14.7846 92.9711 29.8217Z"
          fill="#327CEB"
        />
        <path
          d="M88.1481 44.3681L83.1684 59.4117C77.7308 61.257 71.0825 62.8994 63.42 63.5603C55.2798 64.267 48.1997 63.6781 42.6704 62.7685L48.311 45.7422C53.3822 46.4096 59.5201 46.7499 66.417 46.1544C73.7523 45.5197 80.1519 43.982 85.4521 42.2349H85.4587C86.3748 42.935 87.2713 43.6417 88.1481 44.3681Z"
          fill="#002C6E"
        />
        <path
          d="M76.6708 73.133L70.919 90.4996C63.6884 90.0154 55.3323 88.8833 46.2629 86.5735C38.1031 84.4861 13.7087 76.2019 0 61.1845L3.6513 50.1455L4.81605 46.6382C5.69289 47.3514 6.58936 48.0581 7.50545 48.7648H7.51854C9.36382 50.1848 11.2942 51.5786 13.3161 52.9265C30.7023 64.5479 47.2641 68.3497 55.6725 70.2146C63.2631 71.8767 70.3366 72.7535 76.6708 73.133Z"
          fill="#327CEB"
        />
        <path
          d="M50.2869 28.2314L44.6529 45.2577C39.5817 44.5903 33.4504 44.2566 26.5535 44.852C19.2116 45.4868 12.8186 47.018 7.51828 48.7716H7.5052C6.5891 48.0584 5.69263 47.3517 4.8158 46.6319L9.79544 31.5883C15.2266 29.7364 21.8748 28.1005 29.5373 27.4331C37.6775 26.7264 44.7642 27.3219 50.2869 28.2314Z"
          fill="#002C6E"
        />
      </g>
      <defs>
        <clipPath id="clip0_100_7744">
          <rect
            width="92.9708"
            height="90"
            fill="white"
...
LogoSvg.propTypes = LogoSvgSvgPropTypes
